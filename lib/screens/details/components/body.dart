...
class _BodyState extends State<Body> {
  ...
  Future _addToCart() async {
    ...
    var price = await _productsRef.doc(widget.productId).get();
    var prizy = await price.data()['price'];
    var prizier = int.parse(prizy);
    return _usersRef
        .doc(_user.uid)
        .collection("Cart")
        .doc(widget.productId)
        .set({"size": _selectedProductSize, "price": prizier});
  }
