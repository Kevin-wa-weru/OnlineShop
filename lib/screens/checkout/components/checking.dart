    ...
    try {
      ...
      setState(() {
        ...
        if (_response == 'Similar Order has not been found ') {
          _hoMyDialog(
              'No User From Same depot has placed an order. Continue to Pay half of the fixed Price. In case a similar order is found,you will be notified and additional charges will not apply. Otherwise you will have to pay the rest of delivery fee on delivery');
        } else {
